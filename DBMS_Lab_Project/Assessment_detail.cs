...
namespace DBMS_Lab_Project
{
    public partial class Assessment_detail : Form
    {
        ...
        private void Assessment_detail_Load(object sender, EventArgs e)
        {
            sda = new SqlDataAdapter(@"Select * from Assessment", constr);
            dt = new DataTable();
            sda.Fill(dt);
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (con.State == ConnectionState.Open)
            {
                ...
                string query1 = "delete from Assessment where Id=" + var1 + "";
                SqlCommand cmd = new SqlCommand(query1, con);
                cmd.ExecuteNonQuery();
                string q2 = "select * from Assessment";
                viewR(q2);
