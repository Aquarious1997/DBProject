...
{
    public partial class Rubric_level_detail : Form
    {
        
        public Rubric_level_detail()
        {
            InitializeComponent();
        }
        ...
        private void Rubric_level_detail_Load(object sender, EventArgs e)
        {
            sda = new SqlDataAdapter(@"Select * from RubricLevel", constr);
            dt = new DataTable();
            sda.Fill(dt);
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (con.State == ConnectionState.Open)
            {
                ...
                string query1 = "delete from RubricLevel where Id=" + var1 + "";
                SqlCommand cmd = new SqlCommand(query1, con);
                cmd.ExecuteNonQuery();
                string q2 = "select * from RubricLevel";
                viewR(q2);
                MessageBox.Show("RubricLevel Removed  successfully");
            }
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            Rubric_level_update frm = new Rubric_level_update(ID);
            frm.Show();
            this.Hide();
        }
    }
